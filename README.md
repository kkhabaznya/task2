# Конфигурационное управление. Задание 2. Этап 3. Основные операции
...
- Построение графов на основе полученных зависимостей и аргументах пользователя
- Режим тестирования локального репозитория в виде текстового файла